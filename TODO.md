...
- [ ] [P1] Вкладка «Обогащение»: мастер загрузки CSV, сопоставление колонок, запуск/пауза, прогресс, список результатов (статусы: pending/success/ambiguous/error), кнопки «Принять/Отклонить», «Сохранить CSV».
